...
public class OfficesController {
    ...
    public void readOffices(JTable table) {
        ...
        for (int i = 0; i < numRegisters; i++) {
            ...
            row[3] = officesDaoImple.readOffices().get(i).getAddresLine1();
            row[4] = officesDaoImple.readOffices().get(i).getAddresLine2();
            row[5] = officesDaoImple.readOffices().get(i).getState();
            row[6] = officesDaoImple.readOffices().get(i).getCountry();
            row[7] = officesDaoImple.readOffices().get(i).getPostaleCode();
